...
const INTEGRATIONS = [
  ...
  },
  {
    ...
    label: "Seamless Collaboration Platform",
    product: (
      <a
    ...
    <>
      ...
      <div className="hidden lg:block">
        ...
        <div className="absolute right-56 top-24 flex flex-col gap-10  ">
          ...
          {/* Bottom Card */}
          <div
            className={` mt-16 w-fit rounded-lg border border-gray-200 bg-white-50 px-3 py-2 dark:border-black/50 dark:bg-neutral-100  `}
          >
            <div className="flex items-center gap-2">
